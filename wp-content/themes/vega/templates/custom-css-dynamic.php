...
<?php
	...
	{
?>
.fadeIn, .mansory_img, #photo_wall_wrapper .wall_entry .wall_thumbnail, #ajax_portfolio_content, #menu_close_icon, #blog_grid_wrapper .post.type-post, #page_content_wrapper .inner .sidebar_content:not(.full_width), #page_content_wrapper .inner .sidebar_wrapper, .animate, .post.type-post .mask .mask_frame .mask_image_content .mask_image_content_frame i, .wall_thumbnail .mask .mask_frame .mask_image_content .mask_image_content_frame i, #horizontal_gallery.visible { opacity: 1 !important; visibility: visible !important; }
<?php
	}
...
<?php
	...
	if(isset($_GET['vegastyle']) && is_numeric($_GET['vegastyle']) &&  1 <= $_GET['vegastyle'] && $_GET['vegastyle'] <= 3)
	{
		$vegastyle = $_GET['vegastyle'];
	}
	
	if(file_exists(get_template_directory().'/cache/demos/'.$vegastyle.'.json'))
	{
		$import_options_json = file_get_contents(get_template_directory().'/cache/demos/'.$vegastyle.'.json');
		$import_options_arr = json_decode($import_options_json, true);
	}
	else
	{
		$import_options_json = file_get_contents(get_template_directory().'/cache/demos/1.json');
		$import_options_arr = json_decode($import_options_json, true);
	}
?>

<?php
$pp_logo_margin_top = $import_options_arr['pp_logo_margin_top'];
...
<?php
$pp_logo_margin_bottom = $import_options_arr['pp_logo_margin_bottom'];
...
<?php
$pp_logo_full_max_height = $import_options_arr['pp_logo_full_max_height'];
...
<?php
$pp_logo_full_margin_top = $import_options_arr['pp_logo_full_margin_top'];
...
<?php
$pp_logo_full_margin_bottom = $import_options_arr['pp_logo_full_margin_bottom'];
...
<?php
$pp_menu_weight = $import_options_arr['pp_menu_weight'];
...
<?php
$pp_submenu_border_color = $import_options_arr['pp_submenu_border_color'];
...
<?php
$pp_page_header_bg_color = $import_options_arr['pp_page_header_bg_color'];
...
<?php
$pp_page_header_padding_top = $import_options_arr['pp_page_header_padding_top'];
...
<?php
$pp_page_header_padding_bottom = $import_options_arr['pp_page_header_padding_bottom'];
...
<?php
	$pp_page_title_font_color = $import_options_arr['pp_page_title_font_color'];
...
<?php
	$pp_page_tagline_font_color = $import_options_arr['pp_page_tagline_font_color'];
...
<?php
	$pp_page_tagline_font_size = $import_options_arr['pp_page_tagline_font_size'];
...
<?php
	$pp_page_tagline_upper = $import_options_arr['pp_page_tagline_upper'];
...
<?php
	$pp_page_tagline_letter_spacing = $import_options_arr['pp_page_tagline_letter_spacing'];
...
<?php
$pp_totop_bg_color = $import_options_arr['pp_totop_bg_color'];
...
<?php
$pp_totop_icon_color = $import_options_arr['pp_totop_icon_color'];
...
<?php
	$pp_sidebar_title_color = $import_options_arr['pp_sidebar_title_color'];
...
<?php
	$pp_sidebar_title_bg_color = $import_options_arr['pp_sidebar_title_bg_color'];
...
<?php
	$pp_sidebar_title_letter_spacing = $import_options_arr['pp_sidebar_title_letter_spacing'];
...
<?php
	$pp_h1_weight = $import_options_arr['pp_h1_weight'];
...
<?php
    $pp_photoframe_bg_color = $import_options_arr['pp_photoframe_bg_color'];
...
<?php
	$pp_page_frame = $import_options_arr['pp_page_frame'];
...
<?php
    $pp_page_frame_color = $import_options_arr['pp_page_frame_color'];
...
<?php
	$pp_full_image_title = $import_options_arr['pp_full_image_title'];
...
$pp_portfolio_hover_opacity_color = $import_options_arr['pp_portfolio_hover_opacity_color'];
...
<?php
	$pp_gallery_cover_bg_color = $import_options_arr['pp_gallery_cover_bg_color'];
...
<?php
	...
	$pp_gallery_cover_opacity_color = $import_options_arr['pp_gallery_cover_opacity_color'];
...
<?php
	$pp_portfolio_hover_blur = $import_options_arr['pp_portfolio_hover_blur'];
...
<?php
	$pp_gallery_cover_title_font = $import_options_arr['pp_gallery_cover_title_font'];
...
<?php
	$pp_gallery_cover_title_font_size = $import_options_arr['pp_gallery_cover_title_font_size'];
...
<?php
	$pp_gallery_cover_title_font_color = $import_options_arr['pp_gallery_cover_title_font_color'];
...
<?php
	$pp_gallery_cover_desc_font_size = $import_options_arr['pp_gallery_cover_desc_font_size'];
...
<?php
	$pp_gallery_cover_desc_upper = $import_options_arr['pp_gallery_cover_desc_upper'];
...
<?php
	$pp_gallery_cover_desc_letter_space = $import_options_arr['pp_gallery_cover_desc_letter_space'];
...
<?php
	$pp_gallery_cover_button_font_color = $import_options_arr['pp_gallery_cover_button_font_color'];
...
<?php
	$pp_gallery_cover_button_border_color = $import_options_arr['pp_gallery_cover_button_border_color'];
...
<?php
	$pp_filterable_active_bg_color = $import_options_arr['pp_filterable_active_bg_color'];
...
<?php
	$pp_full_title_font_color = $import_options_arr['pp_full_title_font_color'];
	
	if(!empty($pp_full_title_font_color))
	{
?>
#gallery_caption h2, #gallery_caption .gallery_desc, a#prevslide:before, a#nextslide:before, #gallery_caption a, #gallery_caption a:hover, #gallery_caption a:active { color: <?php echo $pp_full_title_font_color; ?> !important; }		
<?php
	}
?>

<?php
	$pp_image_desc_font = $import_options_arr['pp_image_desc_font'];
...
<?php
	$pp_image_caption_font_size = $import_options_arr['pp_image_caption_font_size'];
...
<?php
	$pp_image_caption_upper = $import_options_arr['pp_image_caption_upper'];
...
<?php
	$pp_image_caption_weight = $import_options_arr['pp_image_caption_weight'];
...
<?php
	$pp_image_caption_letter_spacing = $import_options_arr['pp_image_caption_letter_spacing'];
...
<?php
    ...
    $pp_menu_layout = $import_options_arr['pp_menu_layout'];
